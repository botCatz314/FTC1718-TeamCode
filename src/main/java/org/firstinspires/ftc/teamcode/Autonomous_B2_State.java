...
@Autonomous(name = "Autonomous_B2_State_v1", group = "Pushbot" )

public class Autonomous_B2_State extends LinearOpMode {
    ...
    public void GlyphBoxBlue(int column){
        ...
        if (column == 2) driveTime = 700;
        if (column == 3) driveTime = 900;
    ...
    public void RedSideJewell(Servo servoStickRight1){
